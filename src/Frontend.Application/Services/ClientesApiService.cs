...
public class ClientesApiService : IClientesApiService
{
    ...
    public ClientesApiService(HttpClient httpClient, IOptions<ApiSettings> apiSettings, IJwtTokenService tokenService)
    {
    ...
    public async Task<List<ClienteDto>> ListarActivosAsync()
    {
        ...
        var response = await _httpClient.GetFromJsonAsync<List<ClienteDto>>($"{_apiSettings.CatalogosApiBaseUrl}/api/Clientes");
